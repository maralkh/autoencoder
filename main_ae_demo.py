...
class AutoencoderDemo:
    ...
    def run_transformer_demo(self):
        ...
        try:
            ...
            import transformers
            print(f"✅ Transformers library available (v{transformers.__version__})")
        except ImportError:
        ...
        try:
            ...
            print("❌ Transformer modules not found!")
            print("💡 Make sure transformer_autoencoders folder exists")
            return None
        ...
        print(f"📝 Prepared {len(sample_texts)} sample texts for analysis")
        ...
        try:
            ...
            print("🔗 Running model with attention capture...")
            save_dir = "demo_transformer_attention"
            outputs = runner.run_with_hooks(input_ids, attention_mask, save_dir)
            
            print(f"✅ Captured attention data:")
            print(f"   • Attention inputs: {len(runner.attention_hook.attention_inputs)}")
            print(f"   • Attention outputs: {len(runner.attention_hook.attention_outputs)}")
            print(f"   • Attention weights: {len(runner.attention_hook.attention_weights)}")
            ...
            if runner.attention_hook.attention_weights:
                print("🎯 Creating attention weight visualizations...")
            ...
            print(f"\n✅ Transformer attention analysis completed!")
            print(f"📁 All results saved to: {save_dir}")
            print(f"🔍 Check the directory for:")
            print(f"   • Attention data files (.pkl)")
            print(f"   • Visualization plots (.png)")
            print(f"   • Analysis reports (.txt, .json)")
            ...
            print("💡 Make sure you have sufficient memory and the model can be loaded")
            return None
